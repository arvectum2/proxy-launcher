...
- The canonical macOS production-signing task is completed in v0.2.16; do not reopen its signing/notarization acceptance unless a later material macOS packaging/signing change requires it.
