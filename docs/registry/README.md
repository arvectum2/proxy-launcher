...
## Официальные источники baseline

Проверено 2026-09-17:

- ФГИС «Реестры ПО»: `https://reestr.digital.gov.ru/`;
- текущая памятка оператора о подаче: подтверждённая учётная запись Госуслуг, подготовленные материалы, ПО для электронной подписи и квалифицированный сертификат; далее заявление и приложения подписываются квалифицированной электронной подписью; опубликованный ориентир рассмотрения — до 45 рабочих дней со дня регистрации;
- постановление Правительства РФ №1236: `https://government.ru/docs/all/104296/`;
- постановление Правительства РФ от 28.11.2025 №1937 и график применения подпункта «м»: `https://government.ru/docs/all/162383/`;
- правила перечня доверенного ПО, постановление №1931: `https://government.ru/docs/all/162278/`.

Живая форма и действующая редакция нормативных актов имеют приоритет над этим version-frozen рабочим пакетом.
