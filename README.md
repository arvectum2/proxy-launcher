...
- Windows: rollback now validates every governed WinINET and user proxy-environment field before any restore; saved-or-Arvectum mixed state is recoverable, while newer foreign/admin proxy changes are preserved and block destructive rollback.
