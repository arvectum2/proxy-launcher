            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 22) {
                    ...
                    disclosureRow(
                        ...
                        text: "Адрес, порт и логин сохраняются локально. Пароль хранится в системной Связке ключей macOS. Arvectum не получает эти данные."
                    )

                    disclosureRow(
                        icon: "network",
                        title: "Используется системный VPN-механизм macOS",
