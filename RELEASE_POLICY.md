...
* **Windows (0.2.9):** Verified stable release track with LocalAppData isolation, DPAPI credential protection, ownership-aware WinINET/proxy-environment rollback that preserves newer foreign/admin changes, process-ownership enforcement, installer lifecycle gates, and explicit system-proxy regression coverage.
